...
(function() {
  var check_selected, checked, contabid, data_map, dealBig, dealChecked, dealEd2k, maxid, result, scanColor, selectedIDS, table, toggle_check, trs, wrap_tr;
  ...
  $(document).ready(function() {
    ...
    $("input[data-map]").live("click", function() {
      return data_map[$(this).attr("data-map")]();
    });
